          ...
          {loading ? (
            ...
            > */}
                      <div className="mx-40 mb-5 flex flex-col justify-center items-start">
                        {totalRows.map((row, id) => (
                          ...
                          >
                            <CRow
                              key={id}
                              className="bg-gray-200 rounded-lg relative border-3 w-full flex justify-center items-center border-solid border-gray-400 text-black p-4 mr-10 shadow-black shadow-3xl "
                            >
                              <CCol xs={1} md={3} lg={3}>
                                <CFormSelect
                      ...
                      <div className="flex justify-center items-center flex-col">
                        <button
                          className={`shadow-black shadow-3xl mx-auto px-5 py-2 rounded-lg mb-3 text-xl bg-[#6261CC] transition-all text-white hover:bg-[#464592]`}
                          // type="submit"
                          color="secondary"
                          onClick={startexam}
